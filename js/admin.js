...
renderTechForm=function(t={}){
    ...
    <div class="input-group">
        <input
            ...
            class="form-control"
            type="password"
            ${t.id && !needsAccount ? "disabled" : needsAccount ? "required minlength=12" : "required minlength=12"}
            placeholder="${t.id && !needsAccount ? "Password managed separately" : "12+ character password"}"
        >
        <button
            type="button"
            class="btn btn-outline-secondary"
            id="toggleTechnicianPassword"
            ${t.id && !needsAccount ? "disabled" : ""}
