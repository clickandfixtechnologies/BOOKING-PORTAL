...
function render(r){
  ...
  // Remove any existing duplicate tracking brand header
  document.querySelectorAll(".tracking-brand").forEach(el => el.remove());
